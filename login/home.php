...
<body id="home">
    ...
    <header class="main-header">
        ...
        <nav class="main-header-content">
            ...
            <span class="main-header-content-btn" style="flex-basis: 28% ;">
    ...
    <body id="home">
        ...
        <section class="main-blog">
            ...
            <div class="main-blog-content">
                <article data-aos="fade-up" data-aos-delay="200" data-aos-duration="200">
            ...
            <div class="project-content">
                ...
                <div class="div-border">
                    <div class="progressive">
                        <img data-src="img/20px/procedimento.jpg" class="preview lazy aos-animate" src="img/20px/" alt="Nossas câmeras com excelentes qualidades" title="Nossas câmeras com excelentes
                            qualidades">
                    </div>
                ...
                <div class="div-border">
                    <div class="progressive">
                        <img data-src="img/20px/teste.jpg" src="img/20px/contrato.webp" class="preview lazy" alt="Faço um Contrato Rapido, façil com um clique" title="Faço um Contrato Rapido, façil com um clique" width="100%">
                    </div>
                    <div class="box-single-content">
                        <h1>
                    ...
                    <div class="div-border">
                        <div class="progressive">
                            <img data-src="img/20px/portal.jpg" class="preview lazy" src="img/20px/teste.jpg" alt="Nossas gamas de equipamentos" title="Nossas gamas de equipamentos" width="100%">
                        </div>
                        <div class="box-single-content">
                    ...
                    <div class="div-border">
                        <div class="progressive">
                            <img data-src="img/pixabay2.webp" class="preview lazy" src="img/20px/pixbay2.webp" alt="usamos tecnicas modernas" width="100%">
                        </div>
                        <div class="box-single-content">
                            <h1>Adicionais</h1>
                            <p>
        ...
        <section class="main-team">
            ...
            <div class="main-team-box app">
                ...
                <div class="box-single-team" data-aos="zoom-out">
        ...
        <section class="main-utilites" id="contacto">
            ...
            <div data-aos="fade-up" class="main-utilities-header">
